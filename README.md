...
5. **国际化传播**：在能归属到具体国家的观看量中，日本占比41.3%居首，亚洲整体约86.7%，同时触达美国、法国等欧美市场
![地区分布图图](visuals/地区分布图.png)
6. **流量结构健康**：算法推荐+播放列表+搜索合计占92.36%，平台系统主动分发为主
![流量结构条形图](visuals/流量结构条形图.png)
7. **系列级差异**：Pripara系列表现（观看/完播率）显著优于Aikatsu系列
![系列对比图](visuals/系列对比图.png)
8. **停更原因是供给枯竭而非质量下滑**：Aikatsu完播率前后两批几乎持平，说明转向Pripara并非内容变差
